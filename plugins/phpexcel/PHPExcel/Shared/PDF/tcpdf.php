...
class TCPDF {
	 ...
	 * @param float $w Cell width. If 0, the cell extends_area up to the right margin.
	 * @param float $h Cell height. Default value: 0.
			...
			if ($this->isunicode) {
				if (($this->CurrentFont['type'] == 'core') OR ($this->CurrentFont['type'] == 'TrueType') OR ($this->CurrentFont['type'] == 'Type1')) {
					...
					if (defined('K_THAI_TOPCHARS') AND (K_THAI_TOPCHARS == true)) {
						...
						$topchar = array(3611, 3613, 3615, 3650, 3651, 3652); // chars that extends_area on top
	 ...
	 * @param float $h Cell minimum height. The cell extends_area automatically if needed.
	 * @param string $txt String to print
	 * @param mixed $border Indicates if borders must be drawn around the cell. The value can be a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul> or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul> or an array of line styles for each border group - for example: array('LTRB' => array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)))
